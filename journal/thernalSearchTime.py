...
from algorithm.SGDBase.egraphCellOptimazation3 import cell_optimazation_3_search
...
def main():
    ...
    log_file_name = "test_3s_spars_0919"
    ...
    for g in sorted_graphs:
        ...
        for i in range(20):
            ...
            _log = cell_optimazation_3_search(
                g["graph"], g["name"], log_file_name, i, index_time, True
            )
