...
def cell_optimazation(original_graph, name, dir, time="xxxx"):
    graph = eg.Graph()
    indices = {}
    ...
    # print("crossing angle", eg.crossing_angle_with_crossing_edges(ec))
    # print("crossing edges", eg.crossing_number_with_crossing_edges(ec))
    # print("node resolution", eg.node_resolution(drawing))
